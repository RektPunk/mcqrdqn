...
This project provides a robust implementation of **Monotone Conposite Quantile Regression DQN (MCQR-DQN)** and **Monotone Composite Fully Parameterized Quantile Function (MCFQF)** in PyTorch. Standard Distributional RL methods, such as QR-DQN, often suffer from **quantile crossing**—a phenomenon where the predicted quantiles lose their order, resulting in physically impossible or unstable value distributions. This implementation addresses this issue by employing a monotonicity constraint via a [l1-penalizing method (l1pm)](https://github.com/RektPunk/l1pm).

## Visualization
*Trained MCQR-DQN agents (Seed 42, Episode 0) performing across various environments.*
